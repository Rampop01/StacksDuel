...
import { Trophy, Medal, Star, Flame, User } from './Icons';

const MOCK_CHAMPIONS = [
  { rank: 1, name: 'stx_master.btc', wins: 142, volume: '4.2k', winRate: 94 },
  { rank: 2, name: 'voter_prime.stx', wins: 128, volume: '2.8k', winRate: 88 },
  { rank: 3, name: 'cyber_king.stx', wins: 95, volume: '1.9k', winRate: 82 },
  { rank: 4, name: 'stacks_bot_99', wins: 74, volume: '1.2k', winRate: 75 },
  { rank: 5, name: 'arena_legend', wins: 62, volume: '0.8k', winRate: 68 },
];
